...
const creationsFeatured = [
    ...
    {
        title: 'User Agent Data API',
        description: 'Returns client\'s IP address, OS, brower data, engine, and CPU.',
        'png': 'images/user-agent-data.png',
        'gif': 'images/user-agent-data.png',
        'demo': 'https://req-header-parse-fcc-cozby.herokuapp.com/',
        'code': 'https://github.com/BrentonCozby/req-header-parse-fcc-cozby'
    },
    {
